...
if ( ! class_exists( 'Bravad' ) ) :
	...
	class Bravad {
		...
		public function scripts_styles() {
			...
			wp_enqueue_style( 'aos', get_template_directory_uri() . '/assets/css/aos.css', array(), '3.0.0');
			...
			wp_enqueue_script( 'bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle' . ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min' ) . '.js', array( 'jquery' ), '4.6.2', true );
			...
			wp_enqueue_script( 'aos', get_template_directory_uri() . '/assets/js/aos.js', array( 'jquery' ), '3.0.0', true );
